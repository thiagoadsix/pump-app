...
export function WorkoutExerciseDetailScreen({
  navigation,
  route,
}: NativeStackScreenProps<HomeScreenParamList, 'WorkoutExerciseDetailScreen'>) {
      ...
      <Box flex="1" backgroundColor="primary.900" padding="5">
        ...
        <Box
          ...
          <Text fontSize="18" color="general.900" marginBottom="2">
            Repetitions: {params.set.repetitions}
          </Text>
          <Text fontSize="18" color="general.900" marginBottom="2">
            Series: {params.set.series}
          </Text>
          <Text fontSize="18" color="general.900">
            Weight: {params.set.weight}kg
          </Text>
        </Box>
      </Box>
    </>
