...
import {Exercise, Set} from '../contracts/interfaces';
...
export const SetComponent: React.FC<SetComponentProps> = ({
  set,
  handlePress,
}) => {
  ...
  return (
    <Pressable
      ...
      {imageLoaded && (
        <Box display="flex" flex="1">
          <Text fontSize="18" fontWeight="bold" color="general.900">
            {set.exercise.name}
          </Text>
          <Text fontSize="16" color="general.900">
